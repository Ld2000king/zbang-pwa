...
function submitScoreToLeaderboard() {
    ...
    if (typeof authReady !== 'undefined') {
        // uid stamps the row with this client's identity, which is what stops
        // anyone else from editing it later (see the leaderboard Rules). It
        // comes from authReady rather than auth.currentUser so it is never null.
